    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() ?>Welcome/category_content/<?php echo $category->id ?>"><?php echo $category->category_name ?></a>
                </li>
                <?php endforeach; ?>
...
<?php if (isset($welcome_bar))  { ?>
    <?php  echo $welcome_bar  ?>
<?php } ?>
